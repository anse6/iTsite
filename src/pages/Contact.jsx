...
const Contact = () => {
  const onFinish = (values) => {
    ...
    window.open(
      `mailto:infotechautoserv@gmail.com?subject=Contact Site Web: ${values.subject}&body=De: ${values.name} (${values.email})%0D%0A%0D%0A${values.message}`
    );
  };
      ...
      <div className="flex-1 space-y-6">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-gray-400 max-w-2xl mx-auto">
            Une question ? Un devis ? Notre équipe est à votre écoute 24/7.
          </p>
        </div>
      </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 mb-8">
                N'hésitez pas à nous contacter via WhatsApp pour une réponse
                immédiate, ou remplissez le formulaire ci-contre.
              </p>
            </div>
            ...
            <div className="grid gap-6">
              <Card hoverable className="border-l-4 border-l-primary shadow-md">
                <div className="flex items-start gap-4">
                  <div className="bg-primary/10 p-3 rounded-full text-primary text-2xl">
                    <PhoneOutlined />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 mb-2">
                      Discutez directement avec un expert.
                    </p>
                    <a
                    ...
                    >
                      <Button
                        type="primary"
                        className="bg-green-500 hover:bg-green-600 border-none font-bold"
                      >
                        Ouvrir WhatsApp
                      </Button>
                    </a>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Yaoundé - Derrière Dovv Hôpital Général (Dovv Ngousso)
                    </p>
                  </div>
                </div>
              </Card>
            ...
            <Form layout="vertical" onFinish={onFinish} size="large">
              ...
              <Form.Item>
                <Button
                  ...
                  size="large"
                  block
                  className="h-12 bg-primary hover:bg-primary-dark font-bold shadow-lg shadow-primary/30"
                >
