      ...
      >
        <div className="container mx-auto px-6 h-full flex justify-between items-center">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            <div
              className={`relative w-12 h-12 rounded-2xl flex items-center justify-center text-white font-bold text-2xl shadow-xl transition-all duration-500 overflow-hidden ${
                scrolled
                  ? "bg-primary shadow-primary/30"
                  : "bg-white/20 backdrop-blur-sm shadow-black/10"
              }`}
            >
              <div
          ...
          <nav className="hidden md:flex items-center gap-8 bg-white/5 backdrop-blur-sm px-8 py-3 rounded-full border border-white/10">
            {menuItems.map((item) => (
              ...
              >
                ...
                <span
                  className={`absolute bottom-0 left-0 w-full h-0.5 bg-primary transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300 origin-left ${
          ...
          <div className="mt-auto mb-8">
            <div className="p-6 bg-gray-50 rounded-2xl border border-gray-100">
              ...
              <p className="text-sm text-gray-500 mb-4">
                Nos experts sont disponibles 24/7 pour vous répondre.
              </p>
              <a
                href="https://wa.me/237694852384"
                target="_blank"
              ...
              >
                <Button
                  ...
                  size="large"
                  block
                  className="bg-primary border-none shadow-lg h-12 font-bold rounded-xl"
                >
      ...
      <Footer className="bg-secondary text-white py-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            <div className="col-span-1 md:col-span-1">
              <div className="flex items-center gap-3 mb-6">
                <div className="w-10 h-10 bg-primary rounded-lg flex items-center justify-center text-white font-bold text-lg shadow-lg shadow-primary/40">
                  IT
                </div>
              ...
              <p className="text-gray-400 leading-relaxed text-sm">
                Votre partenaire de confiance pour la sécurité électronique,
                l'automatisme et l'énergie solaire au Cameroun.
              </p>
            </div>

            <div>
              <h3 className="text-lg font-bold mb-6 text-white inline-block relative after:content-[''] after:absolute after:-bottom-2 after:left-0 after:w-12 after:h-1 after:bg-primary after:rounded-full">
                Contact
              </h3>
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a
                  href="#"
                  className="w-12 h-12 rounded-full bg-white/5 flex items-center justify-center hover:bg-primary hover:scale-110 transition-all duration-300 text-white shadow-lg"
                >
        ...
        <div className="border-t border-white/5 bg-black/20 py-8">
          <div className="container mx-auto px-6 text-center text-gray-500 text-sm">
            © {new Date().getFullYear()} IT & Automation Services SARL. Tous
            droits réservés.
          </div>
        </div>
      </Footer>
